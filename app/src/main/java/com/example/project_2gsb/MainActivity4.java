...
/** creation d'un curseur qui recupere l'emploie du temp de la date courante */
        ...
        Cursor Data2=db.getReunion(curDAte);
        int i=0;
        int nb =Data.getCount();
        int nb2=Data2.getCount();
        infoS.setText("nb "+nb);// insertion dans une text box
        rdv = new String[nb+nb2];// implementation du tableau rdv
        ...
        while (Data2.moveToNext()){
            rdv[i]=Data2.getString(2)+ " "+ Data2.getString(3)+" "+ Data2.getString(4);
            i++;
        }
