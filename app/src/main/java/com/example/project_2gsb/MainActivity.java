...
/**
 ...
 liaison avec le quatrieme bouton dans le XML */
    ...
    /**
     * creation de la 5iem methode qui vise a appeler l'ecran 6 pour prendre des reunion
     * liaison avec le 6 ieme bouton dans le XML */
    public void GORDV(View view){
        Intent intentAfficher= new Intent(this, MainActivity6.class);
        startActivity(intentAfficher);
    }
}