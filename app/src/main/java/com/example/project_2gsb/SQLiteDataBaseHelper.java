...
public class SQLiteDataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME3="Reunion";
    public static final String COL_31="ID";
    public static final String COL_32="DATEREU";
    public static final String COL_33="HEUREREU";
    public static final String COL_34="SALLE";
    public static final String COL_35="TYPE";
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("CREATE table "+TABLE_NAME3+"(ID INTEGER PRIMARY KEY AUTOINCREMENT , DATEREU TEXT, HEUREREU TEXT, SALLE TEXT, TYPE TEXT)");
    }
    ...
    /**
     * parametre: dateREU, heureREu , salle, et le types
     * insertion dans la bd a partir des champ saisie en parametre */
    public void insertReunion( String DateReu, String HeureReu, String Salle , String type){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv=new ContentValues();
        cv.put(COL_32,DateReu);
        cv.put(COL_33,HeureReu);
        cv.put(COL_34,Salle);
        cv.put(COL_35,type);
    ...
    public Cursor getReunion(String jour){
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor reuslt2=db.rawQuery("SELECT * FROM "+TABLE_NAME3+" WHERE DATEREU='"+jour+"'",null);
return reuslt2;
    }
